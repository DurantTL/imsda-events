 ...
 * not shaped like an event id is ignored. Used only to pick a default in
 * `resolveLoginDestination` — never to authorize anything on its own (see
 * `last-used-event-cookie.ts`).
 */
