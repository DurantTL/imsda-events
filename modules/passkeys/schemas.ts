...
/**
 * The request shapes every principal's passkey routes accept, shared so the
 * outer envelope is validated identically everywhere. Only the outer shape is
 * checked here; the WebAuthn library validates the contents. Passed through
 * as-is so no field the library needs is dropped.
 */
